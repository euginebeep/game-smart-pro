              ...
              <div className="mt-6 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <Button
                    ...
                    disabled={true}
                    className="w-full bg-white/50 text-gray-400 border-gray-200 font-medium cursor-not-allowed opacity-60"
                  >
                  ...
                  <Button
                    ...
                    disabled={true}
                    className="w-full bg-black/50 text-white/50 border-black/30 font-medium cursor-not-allowed opacity-60"
                  >
                ...
                <p className="text-xs text-center text-muted-foreground mt-1">Em breve</p>
              </div>
            )}
          </form>
