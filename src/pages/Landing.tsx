  ...
  const labels: Record<string, any> = {
    ...
    en: {
      ...
      pricing: {
        ...
        dayUse: { name: 'DAY USE', badge: 'Premium 24h', price: '$4.99', period: '/day', features: ['Full Premium Access for 24h', 'Unlimited Advanced Analysis', 'One-Time Payment', 'No Recurring Charges'], cta: 'Buy Day Use' },
        basic: { name: 'BASIC', price: '$9.90', period: '/month', features: ['5 Games per Day', 'Simple Analysis', '1 Daily Double'], cta: 'Start free →' },
        advanced: { name: 'ADVANCED', badge: '⭐ MOST POPULAR', price: '$14.90', period: '/month', features: ['10 Games per Day', 'Complete Analysis', '3 Daily Doubles', 'Accumulators'], cta: 'Subscribe Advanced' },
        premium: { name: 'PREMIUM', badge: '👑 Best Value', price: '$24.90', period: '/month', features: ['Unlimited Games', 'Full Premium Analysis', 'All Doubles and Zebras', 'Premium Accumulators', 'Report Export', 'Priority Support'], cta: 'Subscribe Premium' },
    ...
    es: {
      ...
      pricing: {
        ...
        dayUse: { name: 'DAY USE', badge: 'Premium 24h', price: '€4,99', period: '/día', features: ['Acceso Premium por 24h', 'Análisis Ilimitados', 'Pago Único', 'Sin Recurrencia'], cta: 'Comprar Day Use' },
        basic: { name: 'BASIC', price: '€9,90', period: '/mes', features: ['5 Juegos por Día', 'Análisis Simple', '1 Doble Diario'], cta: 'Empezar gratis →' },
        advanced: { name: 'ADVANCED', badge: '⭐ MÁS POPULAR', price: '€14,90', period: '/mes', features: ['10 Juegos por Día', 'Análisis Completo', '3 Dobles Diarios', 'Acumuladores'], cta: 'Suscribir Advanced' },
        premium: { name: 'PREMIUM', badge: '👑 Mejor Valor', price: '€24,90', period: '/mes', features: ['Juegos Ilimitados', 'Análisis Premium', 'Todas las Dobles y Zebras', 'Acumuladores Premium', 'Exportación de Informes', 'Soporte Prioritario'], cta: 'Suscribir Premium' },
    ...
    it: {
      ...
      pricing: {
        ...
        dayUse: { name: 'DAY USE', badge: 'Premium 24h', price: '€4,99', period: '/giorno', features: ['Accesso Premium per 24h', 'Analisi Illimitate', 'Pagamento Unico', 'Senza Ricorrenza'], cta: 'Acquista Day Use' },
        basic: { name: 'BASIC', price: '€9,90', period: '/mese', features: ['5 Partite al Giorno', 'Analisi Semplice', '1 Doppia'], cta: 'Inizia gratis →' },
        advanced: { name: 'ADVANCED', badge: '⭐ PIÙ POPOLARE', price: '€14,90', period: '/mese', features: ['10 Partite al Giorno', 'Analisi Completa', '3 Doppie', 'Accumulatori'], cta: 'Abbonati Advanced' },
        premium: { name: 'PREMIUM', badge: '👑 Miglior Valore', price: '€24,90', period: '/mese', features: ['Partite Illimitate', 'Analisi Premium', 'Tutte le Doppie e Zebra', 'Accumulatori Premium', 'Export Report', 'Supporto Prioritario'], cta: 'Abbonati Premium' },
