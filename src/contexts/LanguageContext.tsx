...
const translations: Record<Language, any> = {
  pt: {
    auth: {
      ...
      resetDescription: "Informe seu email cadastrado e enviaremos um código de verificação.",
  ...
  en: {
    auth: {
      ...
      resetDescription: "Enter your registered email and we'll send you a verification code.",
  ...
  es: {
    auth: {
      ...
      resetDescription: "Ingresa tu correo registrado y te enviaremos un código de verificación.",
      sendOtpCode: "Enviar Código",
  ...
  it: {
    auth: {
      ...
      resetDescription: "Inserisci la tua email registrata e ti invieremo un codice di verifica.",
      sendOtpCode: "Invia Codice",
