        ...
        <article className="glass-card p-4 sm:p-6 lg:p-8 animate-fade-in-up bg-primary/10 border-primary/30">
          ...
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary">DUPLA PREMIUM</h3>
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-[10px] sm:text-xs text-muted-foreground uppercase">Odd Total</p>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-6">
            <div className="bg-primary/20 rounded-lg sm:rounded-xl p-2.5 sm:p-3 lg:p-4 text-center border border-primary/30">
              <p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-0.5 sm:mb-1">Chance de Acerto</p>
              <p className="text-2xl sm:text-3xl font-black text-primary">75%</p>
            </div>
            <div className="bg-primary/20 rounded-lg sm:rounded-xl p-2.5 sm:p-3 lg:p-4 text-center border border-primary/30">
              <p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-0.5 sm:mb-1">Retorno</p>
